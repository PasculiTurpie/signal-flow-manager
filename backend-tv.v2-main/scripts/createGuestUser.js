 ...
 *   GUEST_EMAIL     (default: invitado@signaltv-test.example.com)
...
const GUEST_EMAIL = (
  process.env.GUEST_EMAIL || 'invitado@signaltv-test.example.com'
).toLowerCase()
...
async function main() {
  ...
  console.log(
    '\n⚠️  Guarda esta contraseña ahora no vuelve a mostrarse (no se guarda en texto plano en la BD).',
  )
