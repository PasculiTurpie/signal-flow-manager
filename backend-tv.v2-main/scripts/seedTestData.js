...
async function main () {
  ...
  await upsert(
    User,
    { email: 'admin.prueba@signaltv.local' },
    { username: 'Admin Prueba', password: 'Admin123!', role: 'admin' },
    'admin.prueba@signaltv.local (admin)'
  )
  await upsert(
    User,
    { email: 'invitado@signaltv.local' },
    { username: 'Invitado', password: 'Invitado123!', role: 'guest' },
    'invitado@signaltv.local (guest)'
  )
  ...
  const irdDefs = [
    {
      nombreIrd: 'IRD-01-Motorola',
      ipAdminIrd: '10.10.1.11',
      marcaIrd: 'Motorola',
      modelIrd: 'DSR-4410'
    },
    {
      nombreIrd: 'IRD-02-Cisco',
      ipAdminIrd: '10.10.1.12',
      marcaIrd: 'Cisco',
      modelIrd: 'D9865'
    },
    {
      nombreIrd: 'IRD-03-Ericsson',
      ipAdminIrd: '10.10.1.13',
      marcaIrd: 'Ericsson',
      modelIrd: 'RX8200'
    }
  ]
  ...
  const contactDefs = [
    {
      nombreContact: 'Juan Pérez',
      email: 'juan.perez@example.com',
      telefono: '+56911111111'
    },
    {
      nombreContact: 'María González',
      email: 'maria.gonzalez@example.com',
      telefono: '+56922222222'
    },
    {
      nombreContact: 'Pedro Soto',
  ...
  const flowDefs = [
    {
      ...
      edges: [
        { edgeId: 'e1', source: 'f1', target: 'f2', type: 'default', data: {} }
      ]
    }
  ]
  ...
  if (!anyAudit) {
    const created = await AuditLog.create({
      userEmail: 'admin.prueba@signaltv.local',
      role: 'admin',
      action: 'seed',
  ...
  console.log('\n✅ Seed completo.')
  console.log(
    '\nUsuarios de prueba:\n  admin.prueba@signaltv.local / Admin123!\n  invitado@signaltv.local / Invitado123!'
  )
